...
(function() {
  document.addEventListener("DOMContentLoaded", function() {
    var avatar, clamp, d, el, extra_arc, fly, goggles, header_inner, header_lower, header_rect, land, lastX, lastY, ma, map, moving_average, plane, plane_data, plane_id, reset, resize, right, rot, schedule_flight, scroll, was_in_zone, x, y, ydiff, _i, _len, _ref, _ref1;
