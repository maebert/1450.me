...
(function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    var arcs, avatar, clamp, el, extra_arc, fly, goggles, header_inner, header_lower, header_rect, land, lastX, lastY, ma, map, moving_average, plane, plane_data, plane_id, reset, resize, right, rot, schedule_flight, scroll, update_scroll, update_wiggle, was_in_zone, x, y, ydiff, _i, _len, _ref, _ref1;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      console.log("" + (el.getAttribute('data-name')) + " - " + el.className + " - " + (__indexOf.call(el.className, 'nofly') >= 0));
